# function to create type of investment no unknown tables
# usage type_investment_no_unknown_table(df, "Reached")

type_investment_no_unknown_table <- function(df, status) {
