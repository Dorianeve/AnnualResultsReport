...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached annual.xlsx"), overwrite = TRUE)
...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached cumulative strategic.xlsx"), overwrite = TRUE)
...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached cumulative inception.xlsx"), overwrite = TRUE)
