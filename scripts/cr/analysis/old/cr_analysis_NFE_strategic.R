...
today <- today()
folder_path <- paste0("data/output/cr/", Sys.Date(), "/analysis/NFE/")
dir.create(folder_path, recursive = TRUE, showWarnings = FALSE)
wb <- createWorkbook()

# CR NFE ANALYSIS ANNUAL ----
...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached annual NFE strategic.xlsx"), overwrite = TRUE)
...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached cumulative NFE strategic.xlsx"), overwrite = TRUE)
