...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached annual_NoUnknown.xlsx"), overwrite = TRUE)
...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached cumulative strategic_NoUnknown.xlsx"), overwrite = TRUE)
...
# Save the workbook
saveWorkbook(wb, paste0(folder_path, "Children Reached cumulative inception_NoUnknown.xlsx"), overwrite = TRUE)
